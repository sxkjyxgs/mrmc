<template>
  <div id="box">
    <div class="box">
      ...
      <div class="boxx">
        <el-form label-width="380px" class="demo-ruleForm" style="width:80%;">
          <el-form-item
            label="设置推荐页的链接到图文推荐（人气爆款）最多展示数量："
            prop="goods">
            <el-input type="number" auto-complete="off" placeholder="3"></el-input>
          </el-form-item>
        </el-form>
      </div>
      <ul class="show-img">
        <li>
          ...
          <div class="show-shop">
            <el-form label-width="150px" class="demo-ruleForm" style="width:80%;">
              <el-form-item
                label="链接商品"
                prop="goods">
              ...
              <el-form-item
                ...
                <el-upload
                  ...
                  <div slot="tip" class="el-upload__tip">图片中请包含价格与标题</div>
                </el-upload>
              </el-form-item>
              <el-form-item>
          ...
          <div class="show-shop">
            <el-form label-width="150px" class="demo-ruleForm" style="width:80%;">
              <el-form-item
                label="推荐页标题"
                prop="goods">
                <el-input type="age" auto-complete="off" placeholder="输入推荐页标题"></el-input>
              </el-form-item>
              <el-form-item
                label="推荐页展示图片"
                prop="imgs">
